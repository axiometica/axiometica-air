...
| `WATCHER_API_URL` | `http://backend:8000` | AgenticOS API base URL |
...
### 4. Orchestration
The AgenticOS platform receives the incident and orchestrates:
...
- [AgenticOS Platform Architecture](../README.md)
