...
**Version:** v1.7.0 · **Last updated:** June 2026  
...
### Notify
**Purpose:** Emit a mid-workflow notification (Slack message or webhook call).  
**on_failure default:** `continue` — notification failures do not abort the runbook.  
**Fields:** Description, Tool (`slack_notify`, `webhook_notify`), Parameters (channel, message template).
