    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_memory", "target": "verify_memory", "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_disk_full", "target": "verify_disk", "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_service_status", "target": "verify_service_up", "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_service_down", "target": "verify_health", "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_pod_status", "target": "verify_pod_recreation", "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            "steps": [
                ...
                {"id": "notify_done", "name": "Notify Resolution", "type": "notify", "tool": "send_alert", "args": {"message": "Certificate check complete. Expiry: {{new_cert_expiry}} days.", "severity": "info"}},
                {"id": "incident_update_resolve", "name": "Mark Resolved", "type": "incident_update", "state": "resolved"},
            ],
            "edges": [
                ...
                {"source": "dec_cert_expiry", "target": "verify_cert_reload", "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_scale_workers", "target": "verify_queue_depth", "sourceHandle": "false"},
                {"source": "action_scale_up", "target": "wait_after_scale", "sourceHandle": None},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            "steps": [
                ...
                {"id": "notify_done", "name": "Notify Resolution", "tool": "send_alert", "type": "notify", "args": {"message": "Service status: {{service_http_code}}", "severity": "info"}},
                {"id": "incident_update_resolve", "name": "Mark Resolved", "type": "incident_update", "state": "resolved"},
            ],
            "edges": [
                {"source": "start",                       "target": "diag_error_rate",              "sourceHandle": None},
                ...
                {"source": "dec_high_error_rate",         "target": "verify_service",               "sourceHandle": "false"},
                {"source": "action_restart_service",      "target": "wait_for_restart",             "sourceHandle": None},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_health_endpoint",    "target": "verify_health_endpoint", "sourceHandle": "false"},
                ...
                {"source": "dec_error_rate",         "target": "verify_health_endpoint", "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            "steps": [
                ...
                {"id": "update_failed", "name": "Mark Failed", "type": "incident_update", "state": "failed"},
            ],
            "edges": [
                ...
                {"source": "dec_dns_failed",  "target": "verify_dns",       "sourceHandle": "false"},
                ...
                {"source": "notify_fail",     "target": "update_failed",    "sourceHandle": None},
                {"source": "update_failed",   "target": "end",              "sourceHandle": None},
            ],
            "positions": {},
        },
    },
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_port_down","target": "verify_port",  "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_hung",             "target": "verify_health",      "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_fd_critical","target": "verify_fds",   "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_rollout_failed","target": "verify_pods",     "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_pressure","target": "verify_pods",   "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_spike",      "target": "verify_err",   "sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_attack",   "target": "verify_conns","sourceHandle": "false"},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            ...
            "edges": [
                ...
                {"source": "dec_critical","target": "verify_swap",  "sourceHandle": "false"},
        ...
        "source_steps": {
            "steps": [
                ...
                {"id": "verify_isolated", "name": "Verify Isolation", "type": "verification",
                 ...
                 "output_capture": {"conn_count": "$.total_connections"}},
                {"id": "update_security_hold", "name": "Mark Awaiting Investigation",
                 "type": "incident_update", "state": "awaiting_manual"},
                ...
                {"id": "resolve_clean", "name": "Mark Resolved (Clean)", "type": "incident_update", "state": "resolved"},
            ...
            "edges": [
                ...
                {"source": "dec_compromised",   "target": "resolve_clean",      "sourceHandle": "false"},
                ...
                {"source": "verify_isolated",   "target": "update_security_hold","sourceHandle": None},
                {"source": "update_security_hold","target": "notify_incident",  "sourceHandle": None},
                {"source": "notify_incident",   "target": "end",                "sourceHandle": None},
                {"source": "resolve_clean",     "target": "notify_clean",       "sourceHandle": None},
    ...
    # ══════════════════════════════════════════════════════════════════════════
    {
        ...
        "source_steps": {
            "steps": [
                ...
                {"id": "notify_done", "name": "Notify Resolution", "type": "notify", "tool": "send_alert", "args": {"message": "Endpoint status: http_code={{http_code}}.", "severity": "info"}},
                {"id": "incident_update_resolve", "name": "Mark Resolved", "type": "incident_update", "state": "resolved"},
            ],
            "edges": [
                {"source": "start",                  "target": "diag_health",             "sourceHandle": None},
                ...
                {"source": "dec_unreachable",         "target": "verify_endpoint",        "sourceHandle": "false"},
